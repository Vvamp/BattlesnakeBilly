...
public class LoginManagerTest {
    ...
    private void resetLoginManager() throws NoSuchFieldException, IllegalAccessException {
        ...
        Field validatedTokensField = LoginManager.class.getDeclaredField("validatedTokens");
        validatedTokensField.setAccessible(true);
        validatedTokensField.set(null, new ArrayList<>());
